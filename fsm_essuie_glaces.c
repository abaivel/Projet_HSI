...
tTransition transWipers[] = {
    ...
    { ST_WIPERS_ACTIVE, EV_WIPERS_WASHERS_CMD_EG0, NULL, ST_WIPERS_WASHERS_TOUT_ETEINTS},
    ...
    { ST_WIPERS_WASHERS_ACTIVE, EV_WIPERS_WASHERS_CMD_LG0, NULL, ST_WIPERS_WASHERS_TIMER_ETEINTS},
    { ST_WIPERS_WASHERS_TIMER_ETEINTS, EV_WIPERS_WASHERS_CMD_LG1, NULL, ST_WIPERS_WASHERS_ACTIVE},
    { ST_WIPERS_WASHERS_TIMER_ETEINTS, EV_WIPERS_WASHERS_LESS_2SEC, NULL, ST_WIPERS_WASHERS_TIMER_ETEINTS},
    { ST_WIPERS_WASHERS_TIMER_ETEINTS, EV_WIPERS_WASHERS_MORE_2SEC, NULL, ST_WIPERS_WASHERS_TOUT_ETEINTS},
};
...
fsm_wipers_event_t get_next_event(fsm_wipers_event_t current_state)
{
    ...
    switch (current_state) {
        case ST_WIPERS_WASHERS_TOUT_ETEINTS:
        ...
        case ST_WIPERS_WASHERS_ACTIVE:
            ...
            break; 
        case ST_WIPERS_WASHERS_TIMER_ETEINTS:
...
void fsm_blinkers_update(fsm_wipers_state_t *current_state, fsm_wipers_event_t event) {
